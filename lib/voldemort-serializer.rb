...
def double_invert(serde, object)
  return serde.to_object(serde.to_bytes(object))
end
...
def assert(a, b)
  ...
  if((a.kind_of? Array) || (a.kind_of? Hash))
    a = JSON.generate(a)
  end
  
  if((b.kind_of? Array) || (b.kind_of? Hash))
    b = JSON.generate(b)
  end
...
# test primitives
assert(double_invert(get_serde("'string'"), "WASSA"), "WASSA")
assert(double_invert(get_serde("'int8'"), 123), 123)
assert(double_invert(get_serde("'int16'"), 20000), 20000)
assert(double_invert(get_serde("'int32'"), 50123), 50123)
assert(double_invert(get_serde("'int64'"), 9223372036854775807), 9223372036854775807)
assert(double_invert(get_serde("'float32'"), 1),1)
assert(double_invert(get_serde("'float64'"), 23456789), 23456789)
assert(double_invert(get_serde("['int32']"), [23456789, 23]), [23456789, 23])
assert(double_invert(get_serde("['int32']"), [nil]), [nil])
assert(double_invert(get_serde("['int32']"), []), [])
...
assert(double_invert(get_serde("'int8'"), nil), nil)
assert(double_invert(get_serde("'int16'"), nil), nil)
assert(double_invert(get_serde("'int32'"), nil), nil)
assert(double_invert(get_serde("'int64'"), nil), nil)
